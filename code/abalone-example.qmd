...
H~A~: **pH does predict abalone growth (change in shell surface area per day, mm^2^d^-1^)**
...
**With each invrease in pH, the model predicts an increase of 3.0 +/- in change in shell surface area per day (mm^2^ d^-1^)**  
...
**At pH = 8, the model predicts that abalone change in shell surface area per day should be 5.36 mm^2^ day^-1^ (95% CI: [5.08, 5.64])**
